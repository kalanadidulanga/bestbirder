      ...
      <section className=' w-full h-auto overflow-hidden'>
        <div className='bg-image5 bg-cover bg-bottom w-full'>
          <div className=' max-container padding-container flexCenter flex-col w-full'>
            <h1 className=' bold-40 lg:bold-52 mt-24 mb-10 flex gap-3 items-center'><span><MdEmojiPeople /></span>About Us</h1>
            ...
            <div className=' flex flex-col gap-7 md:gap-10 lg:gap-14 mb-24'>
              ...
              <div>
                <h4 className=' bold-18 md:bold-20 lg:bold-32 mb-2 lg:mb-4 text-emerald-500'>Vision</h4>
                <p className=' max-w-4xl text-justify regular-14 md:regular-16 lg:regular-18 tracking-wide'>
                  Our vision to be the most faithful and preferred bird and wildlife tour agency in Sri
                  Lanka.
                </p>
              </div>

              <div>
                <h4 className=' bold-18 md:bold-20 lg:bold-32 mb-2 lg:mb-4 text-emerald-500'>Mission</h4>
                <p className=' max-w-4xl text-justify regular-14 md:regular-16 lg:regular-18 tracking-wide'>
                  To offer an excellent and responsible service that will always give an unforgettable
              ...
              <div>
                ...
                <p className=' max-w-4xl text-justify regular-14 md:regular-16 lg:regular-18 tracking-wide'>
                  ...
                  field biologist and an ornithologist in south and east Asia. He has been working in wildlife
                  research and tourism for nearly 15 years. His studies are mainly focused on wildlife conservation
                  and management at the Open University of Sri Lanka and the Postgraduate institute of
                  Archeology, University of Kelaniya Sri Lanka. He has been working at the Department of
                  Botany, faculty of Science, University of Peradeniya and the Young Zoologist Association of Sri
                  Lanka National Zoo, Sri Lanka, as well as Xishuangbanna Tropical Botanical Garden, Chinese
                  Academy of Sciences and the College of Forestry, Guangxi University in China. Furthermore, he
