...
const Policy = () => {
  return (
    ...
    <>
      ...
      <PageHeader name="Contact Us" image={"/images/birds/6.JPG"}/>
        ...
        <div className='bg-image5 bg-cover bg-bottom w-full'>
          <div className=' max-container padding-container flexCenter flex-col w-full'>
            ...
            <div className=' flex flex-col items-center gap-7 md:gap-10 lg:gap-14 mb-24'>
              <p className=' text-center max-w-4xl regular-14 md:regular-16 lg:regular-18 tracking-wide'>
              ...
              <div className='flex flex-col gap-5 md:gap-8 lg:gap-10 lg:flex-row'>
                <div>
                  <h4 className=' bold-18 md:bold-20 lg:bold-32 mb-2 lg:mb-4 text-primary2'>Tour Schedules</h4>
                ...
                <div>
                  <h4 className=' bold-18 md:bold-20 lg:bold-32 mb-2 lg:mb-4 text-primary2'>Airport pick up and drop</h4>
                  <p className=' max-w-4xl text-justify regular-14 md:regular-16 lg:regular-18 tracking-wide'>
              ...
              <div className='flex flex-col gap-5 md:gap-8 lg:gap-10 lg:flex-row'>
                <div>
                  <h4 className=' bold-18 md:bold-20 lg:bold-32 mb-2 lg:mb-4 text-primary2'>Who we accept</h4>
                  <p className=' max-w-4xl text-justify regular-14 md:regular-16 lg:regular-18 tracking-wide'>
                ...
                <div>
                  <h4 className=' bold-18 md:bold-20 lg:bold-32 mb-2 lg:mb-4 text-primary2'>Payments</h4>
                  <p className=' max-w-4xl text-justify regular-14 md:regular-16 lg:regular-18 tracking-wide'>
